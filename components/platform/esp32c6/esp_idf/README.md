# ESP32-C6 ESP-IDF Peripheral Catalog

This is the lowest ESP32-C6 driver layer. Every listed peripheral has a header and source placeholder, but none has an implementation or is included in a build target yet.
...
- ESP-IDF headers and `esp_err_t` conversion belong only in this directory.
- A UHAL adapter, such as `Esp32C6I2c`, wraps a module here and exposes `uhal::II2c`.
